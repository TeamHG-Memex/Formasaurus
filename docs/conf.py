...
MOCK_MODULES = [
    ...
    'sklearn.model_selection', 'sklearn.grid_search',
...
latex_documents = [
  (master_doc, 'Formasaurus.tex', 'Formasaurus Documentation',
...
man_pages = [
    (master_doc, 'formasaurus', 'Formasaurus Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Formasaurus', 'Formasaurus Documentation',
   author, 'Formasaurus', 'One line description of project.',
   'Miscellaneous'),
]
